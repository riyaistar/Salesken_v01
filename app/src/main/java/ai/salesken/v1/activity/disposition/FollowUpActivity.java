...
public class FollowUpActivity extends SaleskenActivity implements SaleskenActivityImplementation {
...
// Get Current Time
    ...
    private void goBack() {
        Intent i = new Intent(FollowUpActivity.this,CallAnsweredActivity.class);
